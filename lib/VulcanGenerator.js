...
module.exports = class VulcanGenerator extends Generator {
  ...
  */
  ...
  _getStoryBookStatus() {
    return store.getState().storyBookStatus;
  }
  ...
  */
  ...
  _getStoryBookSetupQuestion() {
    return {
      type: 'list',
      name: 'storyBookStatus',
      message: common.messages.storyBookStatus,
      ...
      when: () => {
        const storyBookStatus = this._getStoryBookStatus();
        const allowedStatuses = {
          pending: true,
          installing: true,
          askagain: true
        };
        const isStatusAllowsSetupQuestion = allowedStatuses[storyBookStatus];
