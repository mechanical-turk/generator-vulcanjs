...
module.exports = class VulcanGenerator extends Generator {
  ...
  */
  ...
  _getPackagePath(filepath = '') {
    return this.destinationPath('packages', this.props.packageName, filepath);
  }

  _getModulesIndexPath(filepath = '') {
    return path.join(this._getPackagePath(), 'lib', 'modules', 'index.js', filepath);
  }

  _getModulePath(filepath = '') {
    return this.destinationPath('packages', this.props.packageName, 'lib', 'modules', this.props.moduleName, filepath);
  }
