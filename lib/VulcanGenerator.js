...
module.exports = class VulcanGenerator extends Generator {
  ...
  */
  ...
  _getPackagePath(...args) {
    return this.destinationPath('packages', this.props.packageName, ...args);
  }

  _getLibPath(...args) {
    return this._getPackagePath('lib', ...args);
  }

  _getModulesPath(...args) {
    return this._getLibPath('modules', ...args);
  }

  _getModulePath(...args) {
    return this._getModulesPath(this.props.moduleName, ...args);
  }

  _getComponentsPath(...args) {
    return this._getLibPath('components', ...args);
  }

  _getClientPath(...args) {
    return this._getLibPath('client', ...args);
  }

  _getServerPath(...args) {
    return this._getLibPath('server', ...args);
  }
