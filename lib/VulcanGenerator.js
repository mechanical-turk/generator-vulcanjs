...
module.exports = class VulcanGenerator extends Generator {
  ...
  */
  ...
  _getFinalPackageName(answers) {
    const packageName = this.inputProps.packageName || (this.props ? this.props.packageName : undefined) || answers.packageName;
    return this._filterPackageName(packageName);
  }

  _getFinalModuleName(answers) {
    const moduleName = this.inputProps.moduleName || this.props ? this.props.packageName : undefined || answers.moduleName;
    return this._filterModuleName(moduleName);
  }

  _getFinalPascalModuleName(answers) {
    const moduleName = this.inputProps.moduleName || this.props ? this.props.moduleName : undefined || answers.moduleName;
  ...
  _getFinalDefaultResolvers(answers) {
    return this.inputProps.defaultResolvers || this.props ? this.props.defaultResolvers : undefined || answers.defaultResolvers;
  }
