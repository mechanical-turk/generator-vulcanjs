...
module.exports = class VulcanGenerator extends Generator {
  ...
  */
  ...
  static _getReactExtension () {
    return store.getState().reactExtension;
  }

  static _getPackageNames () {
  ...
  static _getPackage (packageName) {
  ...
  */
  ...
  static _assertHasNonZeroPackages () {
    const packages = store.getState().packages;
  ...
  */
  ...
  static _filterPackageName (packageName) {
    return dashify(packageName);
  }

  static _filterAppName (appName) {
    return dashify(appName);
  }

  static _filterModuleName (moduleName) {
