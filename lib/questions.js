...
function get(questionName) {
  ...
  const moduleNameList = {
    ...
    default: answers => {
      const finalPackageName = this._getFinalPackageName(answers);
      return common.getDefaultChoiceIndex(this._getModuleNames(finalPackageName), this.options.moduleName);
    }
  };
  ...
  const questions = {
    ...
    moduleNameInput: moduleNameInput,
    moduleNameList: moduleNameList,
    isPackageAutoAdd: isPackageAutoAdd,
    componentName: componentName,
    componentType: componentType,
    isRegisterComponent: isRegisterComponent,
    storyBookSetup: storyBookSetup,
    isAddComponentToStoryBook: isAddComponentToStoryBook,
    moduleCreateWith: moduleCreateWith,
    defaultResolver: defaultResolver,
    vulcanDependencies: vulcanDependencies,
    reactExtension: reactExtension,
    packageManager: packageManager,
    isAddCustomSchemaProperty: isAddCustomSchemaProperty,
    schemaPropertyName: schemaPropertyName,
    isSchemaPropertyHidden: isSchemaPropertyHidden,
    schemaPropertyLabel: schemaPropertyLabel,
    schemaPropertyType: schemaPropertyType,
    isSchemaPropertyOptional: isSchemaPropertyOptional,
    schemaPropertyViewableBy: schemaPropertyViewableBy,
    schemaPropertyInsertableBy: schemaPropertyInsertableBy,
    schemaPropertyEditableBy: schemaPropertyEditableBy,
    isAddAnotherCustomSchemaProperty: isAddAnotherCustomSchemaProperty
  };
