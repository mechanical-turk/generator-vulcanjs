...
function get(questionName) {
  ...
  function reactExtension() {
    return {
      ...
      default: common.getDefaultChoiceIndex(common.reactExtensions, generator.options.reactextension)
    };
  }
  ...
  function packageManager() {
    return {
      ...
      default: common.getDefaultChoiceIndex(common.packageManagers, generator.options.packagemanager)
    };
  }
  ...
  function packageNameList() {
    return {
      ...
      default: common.getDefaultChoiceIndex(store.get('packageNames'), generator.options.packagename)
    };
  }
  ...
  function moduleNameList() {
    return {
      ...
      default: answers => {
        ...
        return common.getDefaultChoiceIndex(moduleNames, generator.options.moduleName);
      }
    };
  }
  ...
  const questions = {
    ...
    packageNameWithNumModulesList: packageNameWithNumModulesList,
  ...
  switch (questionName) {
    case 'appName':
      return boundQuestions.appName();
    case 'reactExtension':
      return boundQuestions.reactExtension();
    case 'packageManager':
      return boundQuestions.packageManager();
    case 'packageName':
      return boundQuestions.packageName();
    case 'vulcanDependencies':
      return boundQuestions.vulcanDependencies();
    case 'isPackageAutoAdd':
      return boundQuestions.isPackageAutoAdd();
    case 'packageNameList':
      return boundQuestions.packageNameList();
    case 'moduleName':
      return boundQuestions.moduleName();
    case 'moduleCreateWith':
      return boundQuestions.moduleCreateWith();
    case 'moduleNameList':
      return boundQuestions.moduleNameList();
    case 'defaultResolvers':
      return boundQuestions.defaultResolvers();
    case 'packageNameWithNumModulesList':
      return boundQuestions.packageNameWithNumModulesList();
    default:
      return undefined;
  }
